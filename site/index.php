...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Tech Meetup Uruguay 2014</title>
    ...
    <body class="page-aqua">
					...
					<div class="container">
						...
						<div class="nav-collapse collapse">
							<ul class="nav pull-right">
								...
								<li><a href="http://tech.meetup.uy/v2013" style="color: #f4c42c;">v2013</a></li>
				...
				<div class="row row-txt-dest">
					<div class="span12 text-right">
						<hgroup class="main-title white">
							<h2><span class="txt-destacado1">15 de Noviembre</span></h2>
		...
		<section id="organizacion" class="wrapper-2 bg-emerald colored">
			...
			<!-- Footer -->
			<section class="wrapper footer bg-turquoise colored" id="contacto">
