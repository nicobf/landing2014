...
<html lang="es">
    ...
    <body class="page-aqua">
				...
				<div class="row row-txt-dest">
					<div class="span12 text-right">
						<hgroup class="main-title white">
							<h2><span class="txt-destacado1">23 de Noviembre</span></h2>
							<h3><span class="txt-destacado2">Torre de las Telecomunicaciones de ANTEL.</span></h3>
						</hgroup>
		...
		<section id="speakers" class="wrapper bg-emerald colored">
...
¿Cómo puede mejorar y optimizar el desarrollo de sus proyectos simplemente mejorando la forma de comunicarse con su diseñador? <a target="_blank" href="http://twitter.com/luguedesde"><i class="icon-twitter"></i></a></p>
							...
							<div class="row-fluid team">
								...
								<div class="span10">
									...
									<p>Crecimos en un mundo donde Terminator y las maquinas de Matrix eran algo de ficción. Hoy la robótica y la domótica son algo del día a día pero sólo con buena programación y suficiente maldad vamos a poder lograr que nuestro ejercito robótico se levante.

Un viaje mostrando técnicas y tecnologías para utilizar nuestras habilidades de programación fuera del software y darle vida al hardware. <a target="_blank" href="http://twitter.com/cuerbot"><i class="icon-twitter"></i></a></p>
								</div>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="span12 text-center mar-b30">
						<hgroup>
							<h2>¡Present&aacute; tu charla!</h2>
							<h3> ¿Tenés algo interesante para contar? <br/>Con 30 minutos para presentar tus ideas, este evento será muy intenso y dinámico. ¡Preparate para <br/>mostrar lo que más te interesa! Contanos quién sos, qué hacés y la importancia de tu ponencia.
<br /> <br/>
							Todos tienen la oportunidad de presentarse por igual, porque entendemos que sin ideas nuevas<br/>no hay desarrollo.</h3>
						</hgroup>
			...
			<div class="container">
				<div class="row">
					...
					<div class="span10 text-left">
						<h2>Apoy&aacute; la Conferencia.</h2>
					</div>
						<div class="span2">
...
<br/></h3>
					...
					<div class="span6 text-left">
						<h4>Con tu aporte obtendr&aacute;s:</h4>
...
<section class="wrapper bg-white">
		...
		<section id="apoyan" class="wrapper bg-turquoise">
			...
			<!-- Footer -->
			<section class="wrapper footer bg-emerald colored" id="contacto">
