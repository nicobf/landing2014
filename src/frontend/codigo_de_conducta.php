...
<head>
    ...
    <title>TechMeetup 2014 - Código de Conducta</title>
...
<body>
	...
	<header>
	    ...
	    <div class="header-video" style="height: 190px;">
	...
	<div class="container container-with-margin">
	    <div class="sixteen columns">
	        <section class="section-intro">
	            <h1 class="sixteen columns alpha omega">Código de Conducta de la Conferencia</h1>
				...
				<p><em>Resumiendo: no seas idiota</em></p>
				...
				<p>Se espera que los participantes instados a parar cualquier comportamiento abusivo obedezcan inmediatamente.</p>
				...
				<p>Si un participante incurre en un comportamiento abusivo, los organizadores de la conferencia pueden tomar cualquier acción que estimen oportuna, incluyendo advertencias al ofensor o su expulsión de la conferencia sin reembolso.</p>
				...
				<div class="footer">
					<p>
						<small><em>Fuente original y créditos: <a href="http://2012.jsconf.us/#/about">http://2012.jsconf.us/#/about</a> &amp; <a href="http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy">The Ada Initiative</a><br>
						Por favor, ayuda traduciendo o mejorando: <a href="https://github.com/leftlogic/confcodeofconduct.com">http://github.com/leftlogic/confcodeofconduct.com</a><br>
						Este trabajo está licenciado bajo <a rel="license" href="http://creativecommons.org/licenses/by/3.0/deed.en_US">Creative Commons Atribución 3.0 Unported License</a></em></small>
					</p>
				</div>
	        </section>
	    </div>
			...
			<div class="container">
		        <section class="sixteen columns footer clearfix">
		        	...
		        	<div class="nine columns alpha omega">
		        		...
		        		<a href="#" class="code-of-conduct btn btn-blue">Código de Conducta</a>
